...
const WelcomeBrowserWindow: React.FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      <Toolbar>
        <LocationBar>ThinkThank's Portfolio</LocationBar>
      </Toolbar>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                <a
                  href="https://github.com/ThinkTank-bist"
                  target="_blank"
                  rel="noreferrer"
                  style={{
                    textDecoration: "none",
                ...
                <a
                  href="https://www.linkedin.com/in/ThinkTank"
                  target="_blank"
                  rel="noreferrer"
                  style={{
                    textDecoration: "none",
          ...
          >
            ...
            >
              ...
              <p
                style={{ margin: 0, lineHeight: 1.6 as any, color: "#D8DEE9" }}
              >
                4+ years of experience in malware analysis. CTF management at{" "}
                <strong style={{ color: "#A3BE8C" }}>Thinktank</strong>.
              </p>
            </div>
            ...
            <div
              ...
              onClick={() =>
                window.open("https://www.linkedin.com/in/ThinkTank", "_blank")
              }
              onMouseEnter={e => {
                e.currentTarget.style.transform = "translateY(-3px)";
                e.currentTarget.style.boxShadow =
            ...
            >
              ...
              <p
                style={{ margin: 0, lineHeight: 1.6 as any, color: "#D8DEE9" }}
              >
                Software Engineering, Pentesting at{" "}
                <strong style={{ color: "#EBCB8B" }}>Thinktank</strong>.
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                computer architecture, algorithms, low-level programming.
              </p>
            </div>
          </div>
        </div>
